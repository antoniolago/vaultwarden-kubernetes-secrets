...
public class SecretCacheTests : IDisposable
{
    ...
    public async Task SecretDeletion_ShouldRecreateSecretOnNextSync()
    {
        ...
        _kubernetesServiceMock.Setup(x => x.SecretExistsAsync("default", "test-secret"))
            .ReturnsAsync(false);
        _kubernetesServiceMock.Setup(x => x.CreateSecretAsync("default", "test-secret", It.IsAny<Dictionary<string, string>>(), It.IsAny<Dictionary<string, string>>()))
        ...
        _kubernetesServiceMock.Verify(x => x.CreateSecretAsync("default", "test-secret", It.IsAny<Dictionary<string, string>>(), It.IsAny<Dictionary<string, string>>()), Times.Once);
        ...
        _kubernetesServiceMock.Verify(x => x.CreateSecretAsync("default", "test-secret", It.IsAny<Dictionary<string, string>>(), It.IsAny<Dictionary<string, string>>()), Times.Exactly(2));
    }
    ...
    public async Task OrphanCleanup_ShouldInvalidateCache_WhenDeletingSecrets()
    {
        ...
        _kubernetesServiceMock.Setup(x => x.CreateSecretAsync("default", "current-secret", It.IsAny<Dictionary<string, string>>(), It.IsAny<Dictionary<string, string>>()))
            .ReturnsAsync(OperationResult.Successful());
    ...
    public async Task SecretNameChange_ShouldDeleteOldSecret_AndCreateNew()
    {
        ...
        _kubernetesServiceMock.Setup(x => x.DeleteSecretAsync("default", "original-name"))
            .ReturnsAsync(true);
        _kubernetesServiceMock.Setup(x => x.CreateSecretAsync("default", "custom-secret-name", It.IsAny<Dictionary<string, string>>(), It.IsAny<Dictionary<string, string>>()))
            .ReturnsAsync(OperationResult.Successful());
        ...
        _kubernetesServiceMock.Verify(x => x.CreateSecretAsync("default", "custom-secret-name", It.IsAny<Dictionary<string, string>>(), It.IsAny<Dictionary<string, string>>()), Times.Once);
    }
    ...
    public async Task FailedSecretSync_ShouldRecordErrorInDatabase()
    {
        ...
        _kubernetesServiceMock.Setup(x => x.SecretExistsAsync("nonexistent-namespace", "failing-secret"))
            .ReturnsAsync(false);
        _kubernetesServiceMock.Setup(x => x.CreateSecretAsync("nonexistent-namespace", "failing-secret", It.IsAny<Dictionary<string, string>>(), It.IsAny<Dictionary<string, string>>()))
