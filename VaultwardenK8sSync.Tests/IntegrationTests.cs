...
public class IntegrationTests : IDisposable
{
    ...
    public async Task ExtractSecretDataAsync_WithSecureNote_ShouldPreserveCase()
    {
        ...
        Assert.Equal("This is a secure note with API configuration", result["API-Configuration"]); // Default password key
    }
    ...
    public async Task ExtractSecretDataAsync_NoPassword_WithNotes_ShouldUseNotesAsValue()
    {
        ...
        // Assert
        Assert.True(result.ContainsKey("my-config"), "Should contain password key from notes");
    ...
    public async Task ExtractSecretDataAsync_WithPassword_ShouldUsePasswordAsValue()
    {
        ...
        // Assert
        Assert.True(result.ContainsKey("my-secret"), "Should contain password key");
        Assert.Equal("supersecret", result["my-secret"]);
        Assert.True(result.ContainsKey("my-secret-username"), "Should contain username key");
